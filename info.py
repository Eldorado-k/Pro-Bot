...
auth_channel = environ.get('AUTH_CHANNEL', '-1002800117370') # give your force subscribe channel id here else leave it blank
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002269297479')).split()]
...
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'AntiFlix_d') # Support Chat Links Without https:// or @
...
PUBLIC_FILE_CHANNEL = environ.get('PUBLIC_FILE_CHANNEL', 'AnimLoko') # Public Channel Username Without @ or without https://t.me/ and Bot Is Admin With Full Right.
...
# Clone Information : If Clone Mode Is True Then Bot Clone Other Bots.
CLONE_MODE = bool(environ.get('CLONE_MODE', False)) # Set True or False
PUBLIC_FILE_CHANNEL = environ.get('PUBLIC_FILE_CHANNEL', 'AnimLoko') # Public Channel Username Without @ and Bot Is Admin In Your Channel.
...
VERIFY_SHORTLINK_API = environ.get('VERIFY_SHORTLINK_API', 'nJ0xMvXlLEhpVcJK2MjvU6Vxx6u2')
# if verify second shortner is True then fill below url and api
VERIFY_SND_SHORTLINK_URL = environ.get('VERIFY_SND_SHORTLINK_URL', 'shareus.io')
VERIFY_SND_SHORTLINK_API = environ.get('VERIFY_SND_SHORTLINK_API', 'nJ0xMvXlLEhpVcJK2MjvU6Vxx6u2')
VERIFY_TUTORIAL = environ.get('VERIFY_TUTORIAL', 'https://t.me/TheBlackXYZ/155')
...
SEASONS = ["season 1", "season 2", "season 3", "season 4", "season 5", "season 6", "season 7", "season 8", "season 9", "season 10", "season 11", "season 12", "season 13", "season 14"]
